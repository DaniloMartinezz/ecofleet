...
export default function cardCupom() {
  return (
    <div className="bg-white shadow-md rounded-lg p-3 md:w-[78%] ml-1   font-inter relative overflow-hidden">
      ...
      <div className="text-inter pt-8 md:pt-3">
        ...
        <h2 className="flex items-center md:text-sm text-light-400"><CursorArrowRaysIcon className=" h-6 w-6"/> 10% OFF - CUPOM Ecofleet </h2>
      </div>
    </div>
  );
}
