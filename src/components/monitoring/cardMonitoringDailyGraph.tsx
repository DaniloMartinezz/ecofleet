    ...
    <div className="bg-white rounded-lg shadow p-6 ">
      <div className="flex justify-between items-center">
        <div>
          ...
          <h1 className="text-3xl font-bold text-gray-900">2.579</h1>
          <span className="text-sm font-medium text-gray-400">Visitantes</span>
        </div>
      ...
      <ResponsiveContainer width="100%" height={150}>
        <BarChart data={data} margin={{ top: 20 }}>
          <XAxis dataKey="name" axisLine={false} tickLine={false} tick={{ fontSize: 12, fill: '#CBD5E0' }} />
          <Tooltip />
